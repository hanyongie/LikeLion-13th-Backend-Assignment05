...
public class MemberController {
    ...
    public ApiResTemplate<String> memberSave(@RequestBody MemberSaveRequestDto memberSaveRequestDto) {
        ...
        return ApiResTemplate.successWithContent(SuccessCode.MEMBER_SAVE_SUCCESS);
    }
    ...
    public ApiResTemplate<String>memberUpdate(
            @PathVariable("memberId") Long memberId,
            @RequestBody MemberUpdateRequestDto memberUpdateRequestDto){
        memberService.memberUpdate(memberId, memberUpdateRequestDto);
        return ApiResTemplate.successWithContent(SuccessCode.MEMBER_UPDATE_SUCCESS);
    }

    //회원 id를 통한 사용자 삭제
    @DeleteMapping("/{memberId}")
    public ApiResTemplate<String> memberDelete(
            @PathVariable("memberId") Long memberId) {
        memberService.memberDelete(memberId);
        return ApiResTemplate.successWithContent(SuccessCode.MEMBER_DELETE_SUCCESS);
    }
